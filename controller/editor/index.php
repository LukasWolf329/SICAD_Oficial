...
<body>
  ...
  <div id="shapesPanel">
    ...
    <select id="tagSelector" onchange="insertTag(this.value)">
      ...
      <option value="{{CODIGO}}">Código do Certificado</option>
    </select>
  </div>
  ...
  <div id="templatesPanel">
    <h4>Modelos</h4>
    <div id="templates">
      <img src="https://sicad.linceonline.com.br/controller/assets/certificados/Certificado_1.jpg" alt="Template 1"
        onclick="setTemplate(this.src)">
      <img src="https://sicad.linceonline.com.br/controller/assets/certificados/Certificado_2.jpg" alt="Template 2"
        onclick="setTemplate(this.src)">
      <img src="https://sicad.linceonline.com.br/controller/assets/certificados/Certificado_3.jpg" alt="Template 3"
        onclick="setTemplate(this.src)">
      <img src="https://sicad.linceonline.com.br/controller/assets/certificados/Certificado_4.jpg" alt="Template 4"
        onclick="setTemplate(this.src)">
    </div>
  ...
  <script>
    ...
    function saveCanvas() {
      ...
      fetch('https://sicad.linceonline.com.br/controller/salvarTemplate.php', {
        method: 'POST',
        headers: {
        ...
        .then(async (response) => {
          ...
          console.log("RAW salvarTemplate:", raw);
    ...
    function loadCanvas() {
      ...
      //fetch('http://localhost/SICAD_Oficial/controller/getTemplate.php?atividade_id=' + encodeURIComponent(atividade_id))
      fetch('https://sicad.linceonline.com.br/controller/getTemplate.php?atividade_id=' + encodeURIComponent(atividade_id))
